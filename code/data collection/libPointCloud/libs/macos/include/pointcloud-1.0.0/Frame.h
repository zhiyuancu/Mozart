...
class POINTCLOUD_EXPORT RawFrame: public Frame
{
public:
...
class POINTCLOUD_EXPORT ToFRawFrame : public RawFrame
{
public:
...
class POINTCLOUD_EXPORT PointCloudFrameTemplate: public PointCloudFrame
{
public:
