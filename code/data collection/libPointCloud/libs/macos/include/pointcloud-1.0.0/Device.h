...
#ifndef POINTCLOUD_DEVICE_H
#define POINTCLOUD_DEVICE_H
...
/**
  ...
  * @{
  */
class POINTCLOUD_EXPORT Device
{
public:
  enum Interface {
    USB = 0,
...
class POINTCLOUD_EXPORT USBDevice : public Device
{
...
class POINTCLOUD_EXPORT DeviceScanner
{
protected:
...
class POINTCLOUD_EXPORT USBDeviceScanner : public DeviceScanner
{
protected:
