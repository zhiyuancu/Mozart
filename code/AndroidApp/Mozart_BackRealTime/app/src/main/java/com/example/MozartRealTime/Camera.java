...
public class Camera extends CameraDevice.StateCallback {
    ...
    public Camera(Context context, DepthFrameVisualizer depthFrameVisualizer, String startTIme) {
        this.context = context;
        cameraManager = (CameraManager)context.getSystemService(Context.CAMERA_SERVICE);
        imageAvailableListener = new DepthFrameAvailableListener(depthFrameVisualizer, startTIme);
        previewReader = ImageReader.newInstance(DepthFrameAvailableListener.WIDTH,
                DepthFrameAvailableListener.HEIGHT, ImageFormat.DEPTH16,5);
